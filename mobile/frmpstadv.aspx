<%@ page title="" language="C#" masterpagefile="~/mobile/MasterPage.master" autoeventwireup="true" inherits="user_Default, App_Web_euapsfox" %><%@ Register assembly="AjaxControlToolkit" namespace="AjaxControlToolkit" tagprefix="asp" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Height="482px" Width="772px">
                ...
                <table class="fullbody">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="Submit" style="height: 22px" />
